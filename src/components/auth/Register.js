        ...
        <div className="col-sm-12 col-md-8 col-lg-6 col-xl-5">
          <div id="register-panel" className="card customCard my-5">
            <div className="card-body">
              ...
              {
                this.state.responses['res'] ? (
                  <div className="alert alert-success"><h5><i className='fa fa-check'></i> Pomyślna rejestracja!</h5>Pomyślnie założono konto. Teraz można się <Link to='/login'>zalogować.</Link></div>
                ) : (
                    <form onSubmit={this.handleSubmit}>
                      ...
                      <button type="submit" className="btn btn-block btn-primary mt-4" disabled={this.state.waiting}>{
                        !this.state.waiting ? 'Zarejestruj' : <span><i className='fa fa-spinner fa-spin' aria-hidden='true'></i> Trwa rejestracja...</span>
                      }</button>
